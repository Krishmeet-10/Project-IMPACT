...
public class volunteerLogInPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       EditText editEmail=findViewById(R.id.emailEditText2);
       EditText editPassword=findViewById(R.id.passwordEditText2);
       Button submitButton=findViewById(R.id.logInButton);
       Button forgotButton=findViewById(R.id.forgotVButton);
    ...
    homepage(email,password);
        ...
        forgotButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(volunteerLogInPage.this);
                builder.setTitle("Forgot Password");
                builder.setMessage("Enter your email address:");
                final EditText input = new EditText(volunteerLogInPage.this);
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(volunteerLogInPage.this, "Password reset email sent", Toast.LENGTH_SHORT).show();
                                            } else {
                                                Toast.makeText(volunteerLogInPage.this, "Failed to send password reset email", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        }
